...
class Widgets {
  ...
  static Widget buildItemsCostList (Map<String, dynamic> map) {
      ...
      child: Card(
        child: Padding(
          ...
          child: Column(
            ...
            children: [
              Text('Título: ${map['title']} \n\nValor: ${map['value']}\n\nStatus: ${
                  map['status'] ? 'Pago' : 'Pendente'}'),
            ],
          ),
        ),
      ),
      onTap: () {
        CostDetails cost = CostDetails(value: map['value'], status: map['status'], title: map['title']);
